...
#define MUL_FPS(x,y) ((int32_t)(((int64_t) (x)) * (y) / (1<<14)))
#define DIV_FPS(x,y) ((int32_t)(((int64_t) (x)) * (1<<14) / (y)))
#define ADD_FP_INT(x,n) ((x)+(n)*(1<<14))
#define SUB_FP_INT(x,n) ((x)-(n)*(1<<14))
#define MUL_FP_INT(x,n) ((int32_t)((x)*(n)))
#define DIV_FP_INT(x,n) ((int32_t)((x)/(n)))
